...
SHELL_EDIT_4_OLD = '''                SecondaryButton(
...
SHELL_EDIT_4_NEW = '''                SecondaryButton(
                    text = stringResource(R.string.import_archive_title),
                    palette = palette,
                    compact = true,
                    modifier = Modifier.weight(1f),
...
SHELL_EDITS = [
    ...
    ("add Health Connect data sources button to merged connection card", "insert", SHELL_EDIT_4_OLD, SHELL_EDIT_4_NEW, "R.string.health_connect_data_sources_button"),
]
...
EN_EDITS = [
    (
        "add health_connect_data_sources_button string (EN)",
        "insert",
    ...
    <string name="health_connect_data_sources_button">Open Health Connect settings</string>''',
        "health_connect_data_sources_button",
    ),
]

RU_EDITS = [
    (
        "add health_connect_data_sources_button string (RU)",
        "insert",
